...
# 
# > <img src="attachment:f18_pic.jpg" width="400">
# 
# >> An F/A-18E Super Hornet from the Tophatters of Strike Fighter Squadron (VFA) 14 flies past aircraft carrier USS John C. Stennis in April 2013. (US Navy/MC3 Ignacio D. Perez; picture appeared on the cover of the [2015 June-July issue of Air and Space magazine](https://www.airspacemag.com/military-aviation/about-f-18-photo-180955971/))
# 
# 
...
# 
# This only needs to be done **once on each machine**. The following cell may produce a lot of text output. Don't worry about that. You may also get a message in pink saying that you need to "update pip". Don't do that now, but do tell your instructor if you see other error messages. 
...
# We'll also import the `datascience` package and another packages into our Python session, giving us access to special commands. Just run the next cell by clicking on the boxed code and hitting SHIFT-ENTER. 
...
# 
# > <img src="attachment:99percent.jpg" width="400">
# 
# >> Protesters march in downtown Portland, Oregon on Nov. 17, 2011. (AP Photo/Don Ryan)
# 
# 
