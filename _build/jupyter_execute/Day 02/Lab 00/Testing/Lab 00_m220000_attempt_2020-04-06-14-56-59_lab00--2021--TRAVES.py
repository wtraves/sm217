...
diff = abs(15-128) # make sure that your answer uses the abs function
diff
...
perc = percentile(80, [1,2,4,6,9]) # fill in the ... spots with the appropriate code (Hint: mimic the cell above)
perc
