...
new_weekly_payment = 40 # define a suitably named variable
weeks_in_a_year = 52 # define a suitably named variable
yearly_earnings = weeks_in_a_year * new_weekly_payment # compute yearly_earnings equal
...
perc = percentile(80, [1,2,4,7,9]) # fill in the ... spots with the appropriate code (Hint: mimic the cell above)
perc
